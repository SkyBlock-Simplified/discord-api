...
public final class TitleItem extends SingletonItem<String> {

    private TitleItem(
        @NotNull SelectMenu.Option option,
        boolean editable,
        @NotNull Optional<String> value) {
        super(option, Type.TITLE, editable, value);
    }
    ...
    public static class Builder extends PageItemBuilder<TitleItem> {
        ...
        /**
         * Sets the selected value of the {@link TitleItem}.
         *
