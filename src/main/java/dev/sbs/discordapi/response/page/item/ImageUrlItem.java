...
public final class ImageUrlItem implements SingletonItem<String> {
    ...
    @Override
    public @NotNull ImageUrlItem applyVariables(@NotNull ConcurrentMap<String, Object> variables) {
        return this.mutate()
    ...
    public static @NotNull Builder from(@NotNull ImageUrlItem item) {
        return builder()
    ...
    public static class Builder implements dev.sbs.api.util.builder.Builder<ImageUrlItem> {
