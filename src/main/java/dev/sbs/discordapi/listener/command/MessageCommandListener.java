...
public class MessageCommandListener extends DiscordListener<MessageCreateEvent> {
    ...
    private final @NotNull Function<MessageCreateEvent, Publisher<Class<? extends PrefixCommand>>> prefixFunction;

    public MessageCommandListener(@NotNull DiscordBot discordBot) {
        super(discordBot);
        this.prefixFunction = event -> Mono.justOrEmpty(discordBot.getCommandRegistrar().getPrefixCommand());
    }
