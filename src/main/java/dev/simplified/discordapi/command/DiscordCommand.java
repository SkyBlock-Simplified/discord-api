...
import dev.simplified.discordapi.command.exception.CommandException;
import dev.simplified.discordapi.command.exception.DeveloperPermissionException;
...
import dev.simplified.discordapi.command.exception.SingletonCommandException;
...
public abstract class DiscordCommand<C extends CommandContext<?>> extends DiscordReference implements Function<C, Mono<Void>> {
     ...
     * {@link LocaleHandler} after classpath JSON is
